# *Monday*: Introduction to Survival Analyses and simulation of data {#monday}
...
## `mgus` data from __survival__ package
...
## Non parametric Kalan-Meyer estimation of the survival function
...
2. Sumulate the dates of entry in the cohort, from January, 2010 to January,
   2017
...
3. Simulate the dataset of death, assuming exponential death times of mean $2$
   years
